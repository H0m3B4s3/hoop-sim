...
`tests/test_web.py` checks the serializers against the engine and drives a short game loop
through the API. It auto-skips if the `web` extra isn't installed.
